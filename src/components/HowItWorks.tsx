  ...
  const stepsData = [
    {
      ...
      description: "Fill out the application form to join our exclusive KTM X-BOW showcase program and secure your spot.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "02",
      title: "Personalization",
      description: "We'll work with you to customize your KTM X-BOW experience to your specific preferences and requirements.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Integration",
      description: "Your KTM X-BOW arrives at your preferred location for a personalized showcase experience.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "04",
      title: "Experience",
      description: "Enjoy the thrill of the KTM X-BOW as you experience its unique features and performance capabilities.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    }
  ];
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">How to Experience the KTM X-BOW</h2>
          <p className="section-subtitle mx-auto">
            A seamless four-step process from request to full experience.
          </p>
        </div>
