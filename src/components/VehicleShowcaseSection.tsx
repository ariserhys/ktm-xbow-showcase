...
const VehicleShowcaseSection = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full py-20 bg-gray-100" id="vehicle-showcase">
        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4">
              Racing Heritage Meets <span className="text-[#FC4D0A]">Road Performance</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The KTM X-BOW represents the perfect fusion of track-bred engineering and 
              road-legal performance, designed to deliver an unmatched driving experience.
            </p>
          </div>
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            <img 
              ...
              alt="KTM X-BOW in dynamic driving position" 
              className="w-full object-cover"
            />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">Track-Inspired Design</h3>
                  <p className="text-white/80">Engineered for pure driving pleasure</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Advanced Aerodynamics</h4>
              <p className="text-gray-600">Race-inspired aerodynamic design provides exceptional downforce and stability at high speeds.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Lightweight Construction</h4>
              <p className="text-gray-600">Carbon fiber monocoque chassis delivers exceptional strength-to-weight ratio for superior handling.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Race-Tuned Suspension</h4>
              <p className="text-gray-600">Professional-grade suspension system provides precise handling and responsive feedback on any road.</p>
            </div>
          </div>
        </div>
      </div>
